...
insert = function(arg0,arg1,arg2){
    ...
    if(query.selector.isArray()){
        ...
        returning = query.selector.forEach(function(){
            ids.push(c[ಠ_ಠ.collections[collectionName]].insert(selector,selector,cb));
        });
        return ids;
    }else{
        return c[ಠ_ಠ.collections[collectionName]].insert(selector,selector,cb);
    }
}
...
update = function(arg0,arg1,arg2,arg3,arg4){
    ...
    var collectionName = query1.name,
        ...
        cb = quer2.callback;
    return c[ಠ_ಠ.collections[collectionName]].update(selector,modifier,options,cb);
}
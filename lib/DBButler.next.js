...
export var ↂωↂ = function(){
  ...
  ↂωↂ.updateOne = function(){ return _updateOne.apply(ↂωↂ,arguments) }

  ↂωↂ.upsert = function(){ return _upsert.apply(ↂωↂ,arguments) }

 //a simplified version of updates
  ↂωↂ.edit = function(){ return _edit.apply(ↂωↂ,arguments) }

  ↂωↂ.increase = function(){ return _increase.apply(ↂωↂ,arguments) }

  ↂωↂ.remove = function(arg0,arg1,arg2,isDemolishing){ return _remove.apply(ↂωↂ,arguments);}
